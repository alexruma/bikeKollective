...
class Bikes {
  ...
  Bikes({required this.available, required this.category,required this.condition,
        required this.cur_user, required this.id, required this.location,
       required this.lock, required this.model, required this.rating,
        required this.stolen, required this.year });

  factory Bikes.fromFS(Map<String, dynamic> data){
    return Bikes(available: data['available'],
